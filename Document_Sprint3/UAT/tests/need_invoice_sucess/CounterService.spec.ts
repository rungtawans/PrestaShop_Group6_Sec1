...
test('test', async ({ page }) => {
 ...
 await page.getByRole('button', { name: 'Continue' }).click();
 await page.locator('#payment-option-2-container').getByText('Counter Service').click();
 await page.getByRole('textbox').click();
 await page.getByRole('textbox').setInputFiles('tests/qrcode.jpg');
 await page.goto('http://localhost:8080/en/order-confirmation?id_cart=126&id_module=39&id_order=71&key=53c2a977f4cdf0a4623d7288bc3a38f7');
