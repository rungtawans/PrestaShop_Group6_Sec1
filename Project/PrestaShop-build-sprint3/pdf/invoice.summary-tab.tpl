...
<table id="summary-tab" width="100%">
	<tr>
		<th class="header small" valign="middle">{l s='Tax Invoice Number' d='Shop.Pdf' pdf='true'}</th>
		<th class="header small" valign="middle">{l s='Tax Invoice Date' d='Shop.Pdf' pdf='true'}</th>
